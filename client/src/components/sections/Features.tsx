...
const successStories = [
  ...
  },
  {
    ...
    client: "Y・T様（50代）",
    description:
      "先祖代々農家で郊外にある広大な農地を相続しました。現金もなく相続税は何とか払えましたが、農業を継ぐ考えもないので、私の代で農地を処分しようと決意し不動産会社に相談していました。しかし、大手から地元の不動産会社まで20社以上に相談しましたが、どこの不動産会社も取扱いできませんとの回答でした。途方に暮れインターネットで相談できる会社を探していたところHY Consulting様にこうせダメだろうと半分諦めの気持ちで問い合わせしました。\n\nまず不動産コンサルタントの先生が2か月ほど時間をかけて農地を調査してくださいました。結果、確かに今のままでは売却は困難との回答でした。しかし、このような手順を踏めば売却できる可能性はあるという事で、解決策を提示いただいた点が他の不動産会社と違う対応でした。\n\n広大な土地の測量、道路やインフラの整備費用、造成費等、膚大な費用が必要で、それらを調査を進めないと、何も進められないとの事でした。ただ、この調査には相当な時間と費用が掛かるため、不動産コンサルティング契約を締結した上で、調査を進めていただきました。\n\n依頼してから2年弱が経ちますが、無事に農地全ての処分が完了し安堵しております。色々な不動産会社に相談してきましたが、柔軟な発想で解決策をお示しいただけたのはHY Consultig様だけでした。日本全国不動産の処分で困っている方が多くいらっしゃると思いますので、これからもその方々のお力になってあげてください。",
