...
export default function Contact() {
  return (
    <section id="contact" className="py-20 lg:py-32 bg-primary text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24">
          ...
          >
            ...
            <h2 className="text-3xl lg:text-4xl font-bold mb-8 font-heading leading-tight text-white">
              無料相談・お問い合わせ
            </h2>
            <p className="text-slate-100 mb-12 leading-relaxed font-sans">
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <p className="text-sm text-white/80 mb-1 font-bold uppercase tracking-wider">お電話でのお問い合わせ</p>
                  <a href="tel:045-123-4567" className="text-2xl lg:text-3xl font-bold hover:text-white/90 transition-colors font-heading tracking-wide text-white">
                    045-123-4567
                  </a>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  <p className="text-sm text-white/80 mb-1 font-bold uppercase tracking-wider">所在地</p>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  <p className="text-sm text-white/80 mb-1 font-bold uppercase tracking-wider">メールでのお問い合わせ</p>
                  <p className="text-lg font-medium text-white">info@hy-consulting.jp</p>
                </div>
              </div>
            </div>
          </motion.div>
