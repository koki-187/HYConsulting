    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-24">
          ...
          >
            HY Consultingのサポートで、多くのお客様が人生・家族の課題を解決し、<br className="hidden lg:block" />
            豊かさや安らぎと新たな人生の選択肢を手に入れています。
          </motion.p>
        </div>
